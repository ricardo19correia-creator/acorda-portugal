...
import { handleGoogleLogin, performLogout } from '@/lib/auth-helpers'
...
// 18 Views dos Módulos
import { DashboardView } from '@/components/admin/views/DashboardView'
import { JogadoresView } from '@/components/admin/views/JogadoresView'
import { ComunidadeView } from '@/components/admin/views/ComunidadeView'
  ...
  useEffect(() => {
    ...
    try {
      if (typeof window !== 'undefined') {
        ...
        if (tab && ADMIN_NAV_ITEMS.some((n) => n.id === tab)) {
          setActiveModule(tab as AdminModuleId)
        }
      }
    } catch {}
  }, [])
