...
function EntrarPageContent() {
  ...
  return (
    <div className="relative min-h-screen bg-background flex flex-col justify-between px-4 py-8 sm:px-6 lg:px-8">
      <BackgroundFx />
      ...
      <div className="relative z-20 mx-auto w-full max-w-md my-8">
        <div className="card-game overflow-hidden rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/20">
          ...
          {/* 1. Google OAuth CTA (Top Option for Login & Register) */}
          {mode !== 'reset' && (
            <div className="mt-5">
              <button
                type="button"
