        ...
        async (docSnap) => {
          ...
          if (docSnap.exists()) {
            ...
            const loadedProfile: UserProfile = {
              ...
              losses: typeof data.stats?.duelsLost === 'number' ? data.stats.duelsLost : (typeof data.losses1v1 === 'number' ? data.losses1v1 : 0),
              ...
              draws1v1: typeof data.stats?.duelsDrawn === 'number' ? data.stats.duelsDrawn : (typeof data.draws1v1 === 'number' ? data.draws1v1 : (typeof data.draws === 'number' ? data.draws : 0)),
