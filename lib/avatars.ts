...
export const REAL_AVATARS: AvatarItem[] = [
  ...
  },
  {
    ...
    badge: 'Épico',
    rarity: 'epico',
    glowColor: 'border-indigo-600/60 shadow-[0_0_20px_rgba(79,70,229,0.35)]',
    icon: '♟️',
  ...
  },
  {
    ...
    badge: 'Raro',
    rarity: 'raro',
    glowColor: 'border-lime-500/60 shadow-[0_0_20px_rgba(132,204,22,0.35)]',
    icon: '💡',
  ...
  },
  {
    ...
    badge: 'Lendário',
    rarity: 'lendario',
    glowColor: 'border-blue-400/60 shadow-[0_0_20px_rgba(96,165,250,0.35)]',
    icon: '⚓',
  ...
  // =========================================================================
  // =========================================================================
  // VIP COLLECTION 2.0 — SIGNATURE AVATARS
  // =========================================================================
  {
    id: 'AP-VIP-SIGNATURE-001',
    name: 'Imperador Lusitano',
    subtitle: 'Monarca supremo português redesenhado como a personagem definitiva do Acorda Portugal.',
    image: '/images/avatars/vip/signature/imperador-lusitano.webp',
    category: 'historia',
    price: '€39,99',
    currency: 'real_money',
    badge: 'Mítico',
    rarity: 'mitico',
    glowColor: 'border-amber-400 shadow-[0_0_35px_rgba(251,191,36,0.7)]',
    icon: '👑',
    description: 'Monarca supremo português com manto real ornamentado e silhueta dourada iluminada.',
  },
  {
    id: 'AP-VIP-SIGNATURE-002',
    name: 'Dragão de Portugal',
    subtitle: 'Campeão colossal inspirado no dragão lusitano com escamas reluzentes e olhos ardentes.',
    image: '/images/avatars/vip/signature/dragao-portugal.webp',
    category: 'geral',
    price: '€34,99',
    currency: 'real_money',
    badge: 'Mítico',
    rarity: 'mitico',
    glowColor: 'border-emerald-500 shadow-[0_0_35px_rgba(16,185,129,0.7)]',
    icon: '🐉',
    description: 'Campeão colossal inspirado no dragão lusitano com armadura mítica e brasas ardentes.',
  },
  {
    id: 'AP-VIP-SIGNATURE-003',
    name: 'Navegador Eterno',
    subtitle: 'Capitão explorador lendário que conjuga navegação histórica com armadura futurista.',
    image: '/images/avatars/vip/signature/navegador-eterno.webp',
    category: 'geografia',
    price: '€29,99',
    currency: 'real_money',
    badge: 'Lendário',
    rarity: 'lendario',
    glowColor: 'border-sky-400 shadow-[0_0_30px_rgba(56,189,248,0.6)]',
    icon: '🧭',
    description: 'Capitão explorador lendário com astrolábio e bússola de brilho perpétuo.',
  },
  {
    id: 'AP-VIP-SIGNATURE-004',
    name: 'Guardião da Nação',
    subtitle: 'Protetor monumental com armadura inspirada em Portugal e escudo impenetrável.',
    image: '/images/avatars/vip/signature/guardiao-nacao.webp',
    category: 'historia',
    price: '€24,99',
    currency: 'real_money',
    badge: 'Lendário',
    rarity: 'lendario',
    glowColor: 'border-purple-400 shadow-[0_0_30px_rgba(192,132,252,0.6)]',
    icon: '🛡️',
    description: 'Protetor monumental de elite com anel de energia defensiva.',
  },
  // Aliases Legados para Retrocompatibilidade
  {
    id: 'vip_avatar_001',
    name: 'Imperador Lusitano (Legado)',
    subtitle: 'Avatar imperial inspirado na identidade histórica portuguesa.',
    image: '/images/avatars/vip/signature/imperador-lusitano.webp',
    category: 'historia',
    price: '€39,99',
    currency: 'real_money',
    badge: 'Mítico',
    rarity: 'mitico',
    glowColor: 'border-amber-400 shadow-[0_0_30px_rgba(251,191,36,0.6)]',
    icon: '👑',
    description: 'Avatar imperial inspirado na identidade histórica portuguesa.',
  },
  {
    id: 'vip_avatar_002',
    name: 'Dragão de Portugal (Legado)',
    subtitle: 'O guardião supremo do Desafio Nacional.',
    image: '/images/avatars/vip/signature/dragao-portugal.webp',
    category: 'geral',
    price: '€34,99',
    currency: 'real_money',
    badge: 'Mítico',
    rarity: 'mitico',
    glowColor: 'border-rose-500 shadow-[0_0_35px_rgba(244,63,94,0.7)]',
    icon: '🛡️',
    description: 'O guardião supremo do Desafio Nacional.',
  },
];
...
const ALIAS_MAP: Record<string, string> = {
  ...
  // VIP COLLECTION 2.0 — SIGNATURE AVATARS
  'AP-VIP-SIGNATURE-001': 'AP-VIP-SIGNATURE-001',
  'AP-VIP-SIGNATURE-002': 'AP-VIP-SIGNATURE-002',
  'AP-VIP-SIGNATURE-003': 'AP-VIP-SIGNATURE-003',
  'AP-VIP-SIGNATURE-004': 'AP-VIP-SIGNATURE-004',
  '/images/avatars/vip/signature/imperador-lusitano.webp': 'AP-VIP-SIGNATURE-001',
  '/images/avatars/vip/signature/dragao-portugal.webp': 'AP-VIP-SIGNATURE-002',
  '/images/avatars/vip/signature/navegador-eterno.webp': 'AP-VIP-SIGNATURE-003',
  '/images/avatars/vip/signature/guardiao-nacao.webp': 'AP-VIP-SIGNATURE-004',

  // 6 Avatares VIP Legados
  ...
  vip_avatar_005: 'AP-VIP-SIGNATURE-001',
  vip_avatar_006: 'AP-VIP-SIGNATURE-003',
  '/images/avatars/vip/vip_avatar_001.svg': 'AP-VIP-SIGNATURE-001',
  '/images/avatars/vip/vip_avatar_002.svg': 'AP-VIP-SIGNATURE-002',
  '/images/avatars/vip/vip_avatar_003.svg': 'AP-VIP-SIGNATURE-003',
  '/images/avatars/vip/vip_avatar_004.svg': 'AP-VIP-SIGNATURE-004',
  '/images/avatars/vip/vip_avatar_005.svg': 'AP-VIP-SIGNATURE-001',
  '/images/avatars/vip/vip_avatar_006.svg': 'AP-VIP-SIGNATURE-003',
};
