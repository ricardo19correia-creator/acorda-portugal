...
async function runAcceptanceTests() {
  ...
  assert(buildInfoCode.includes("version: '1.0.0-rc.11'"), 'lib/build-info.ts com versão canónica 1.0.0-rc.11')
  assert(buildInfoCode.includes("commit: 'forensic-session-v11'"), 'lib/build-info.ts com commit hash forensic-session-v11')
