...
const batchFile = 'data/batches/batch_atualidade_portugalnomundo_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      category: 'Atualidade',
      tema: 'Atualidade',
      subtema: 'Portugal no Mundo',
      subcategory: 'Portugal no Mundo',
    })
