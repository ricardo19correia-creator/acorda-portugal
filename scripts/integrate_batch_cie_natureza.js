...
const batchFile = 'data/batches/batch_ciencia_natureza_001.json'
const targetCategoryFile = 'lib/data/categories/ciencia-tecnologia.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      subtema: 'Natureza & Biodiversidade',
      subcategory: 'Natureza & Biodiversidade',
    })
...
prodLogs.push({
  batchId: 'BATCH_CIE_NATUREZA_001',
