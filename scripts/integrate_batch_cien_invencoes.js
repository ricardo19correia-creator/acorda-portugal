...
const batchFile = 'data/batches/batch_ciencia_invencoes_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      subtema: 'Invenções & Descobertas',
      subcategory: 'Invenções & Descobertas',
    })
...
prodLogs.push({
  batchId: 'BATCH_CIEN_INVENCOES_001',
