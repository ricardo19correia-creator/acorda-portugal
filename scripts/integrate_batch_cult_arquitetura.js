...
const batchFile = 'data/batches/batch_cultura_arquitetura_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      category: 'Cultura',
      tema: 'Cultura',
      subtema: 'Arquitetura & Monumentos',
      subcategory: 'Arquitetura & Monumentos',
    })
...
prodLogs.push({
  batchId: 'BATCH_CULT_ARQUITETURA_001',
