...
const batchFile = 'data/batches/batch_cultura_patrimonio_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      category: 'Cultura',
      tema: 'Cultura',
      subtema: 'Património da Humanidade',
      subcategory: 'Património da Humanidade',
    })
...
prodLogs.push({
  batchId: 'BATCH_CULT_PATRIMONIO_001',
