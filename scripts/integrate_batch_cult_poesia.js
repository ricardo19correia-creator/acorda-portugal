...
const batchFile = 'data/batches/batch_cultura_poesia_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...q,
      category: 'Cultura, Arte e Tradições',
      tema: 'Cultura, Arte e Tradições',
      subtema: 'Poesia',
      subcategory: 'Poesia',
    })
...
prodLogs.push({
  batchId: 'BATCH_CULT_POESIA_001',
  timestamp: new Date().toISOString(),
  category: 'cultura',
  theme: 'Cultura, Arte e Tradições',
  subtema: 'Poesia',
  count: addedCount,
  qualityGate: 'PASSED',
  sourceVerified: true,
