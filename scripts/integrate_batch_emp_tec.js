...
const batchFile = 'data/batches/batch_empresas_tecnologicas_001.json'
const targetCategoryFile = 'lib/data/categories/empresas-portuguesas.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...q,
      category: 'Empresas Portuguesas',
      tema: 'Empresas Portuguesas',
      subtema: 'Empresas Tecnológicas',
      subcategory: 'Empresas Tecnológicas',
    })
...
prodLogs.push({
  batchId: 'BATCH_EMP_TEC_001',
  timestamp: new Date().toISOString(),
  category: 'empresas-portuguesas',
  theme: 'Empresas Portuguesas',
  subtema: 'Empresas Tecnológicas',
  count: addedCount,
  qualityGate: 'PASSED',
  sourceVerified: true,
