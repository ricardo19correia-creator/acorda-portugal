...
const batchFile = 'data/batches/batch_futebol_curiosidades_001.json'
const targetCategoryFile = 'lib/data/categories/futebol-portugues.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...q,
      category: 'Futebol Português',
      tema: 'Futebol Português',
      subtema: 'Curiosidades do Futebol',
      subcategory: 'Curiosidades do Futebol',
    })
...
prodLogs.push({
  batchId: 'BATCH_FUT_CURIOS_001',
  timestamp: new Date().toISOString(),
  category: 'futebol-portugues',
  theme: 'Futebol Português',
  subtema: 'Curiosidades do Futebol',
  count: addedCount,
  qualityGate: 'PASSED',
  sourceVerified: true,
