...
const batchFile = 'data/batches/batch_gastronomia_regional_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...q,
      category: 'Gastronomia Portuguesa',
      tema: 'Gastronomia Portuguesa',
      subtema: 'Gastronomia Regional',
      subcategory: 'Gastronomia Regional',
    })
...
prodLogs.push({
  batchId: 'BATCH_GAST_REGIONAL_001',
  timestamp: new Date().toISOString(),
  category: 'gastronomia',
  theme: 'Gastronomia Portuguesa',
  subtema: 'Gastronomia Regional',
  count: addedCount,
  qualityGate: 'PASSED',
  sourceVerified: true,
