...
const batchFile = 'data/batches/batch_geografia_concelhos_001.json'
const targetCategoryFile = 'lib/data/categories/geografia.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      category: 'Geografia',
      tema: 'Geografia',
      subtema: 'Concelhos e Freguesias',
      subcategory: 'Concelhos e Freguesias',
    })
...
prodLogs.push({
  batchId: 'BATCH_GEO_CONCELHOS_001',
