...
const batchFile = 'data/batches/batch_geografia_distritos_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      category: 'Geografia',
      tema: 'Geografia',
      subtema: 'Distritos de Portugal',
      subcategory: 'Distritos de Portugal',
    })
...
prodLogs.push({
  batchId: 'BATCH_GEO_DISTRITOS_001',
