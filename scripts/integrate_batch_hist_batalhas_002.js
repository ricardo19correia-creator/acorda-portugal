...
const batchFile = 'data/batches/batch_historia_batalhas_002.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      category: 'História',
      tema: 'História',
      subtema: 'Batalhas Históricas',
      subcategory: 'Batalhas Históricas',
    })
...
prodLogs.push({
  batchId: 'BATCH_HIST_BATALHAS_002',
