...
const batchFile = 'data/batches/batch_historia_dinastias_002.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      category: 'História',
      tema: 'História',
      subtema: 'Dinastias Portuguesas',
      subcategory: 'Dinastias Portuguesas',
    })
...
prodLogs.push({
  batchId: 'BATCH_HIST_DINASTIAS_002',
