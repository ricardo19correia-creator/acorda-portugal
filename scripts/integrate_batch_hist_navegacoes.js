...
const batchFile = 'data/batches/batch_historia_navegacoes_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      category: 'História',
      tema: 'História',
      subtema: 'Grandes Navegações',
      subcategory: 'Grandes Navegações',
    })
...
prodLogs.push({
  batchId: 'BATCH_HIST_NAVEGACOES_001',
