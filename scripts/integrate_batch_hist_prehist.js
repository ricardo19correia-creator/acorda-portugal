...
const batchFile = 'data/batches/batch_historia_prehistoria_001.json'
const targetCategoryFile = 'lib/data/categories/historia.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      subtema: 'Pré-História & Antiguidade',
      subcategory: 'Pré-História & Antiguidade',
    })
...
prodLogs.push({
  batchId: 'BATCH_HIST_PREHIST_001',
  timestamp: new Date().toISOString(),
  category: 'historia',
  theme: 'História de Portugal',
  subtema: 'Pré-História & Antiguidade',
  count: addedCount,
  qualityGate: 'PASSED',
  sourceVerified: true,
