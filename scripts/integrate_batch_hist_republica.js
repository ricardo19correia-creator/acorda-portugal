...
const batchFile = 'data/batches/batch_historia_republica_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      category: 'História',
      tema: 'História',
      subtema: 'República & Século XX',
      subcategory: 'República & Século XX',
    })
...
prodLogs.push({
  batchId: 'BATCH_HIST_REPUBLICA_001',
