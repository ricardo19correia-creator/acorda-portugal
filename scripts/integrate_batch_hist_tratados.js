...
const batchFile = 'data/batches/batch_historia_tratados_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      category: 'História',
      tema: 'História',
      subtema: 'Tratados & Diplomacia',
      subcategory: 'Tratados & Diplomacia',
    })
...
prodLogs.push({
  batchId: 'BATCH_HIST_TRATADOS_001',
