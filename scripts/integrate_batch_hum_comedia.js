...
const batchFile = 'data/batches/batch_humor_comedia_001.json'
const targetCategoryFile = 'lib/data/categories/humor.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      category: 'Humor',
      tema: 'Humor',
      subtema: 'Comédia na TV & Cinema',
      subcategory: 'Comédia na TV & Cinema',
    })
