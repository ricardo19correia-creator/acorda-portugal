...
const batchFile = 'data/batches/batch_musica_cantores_001.json'
const targetCategoryFile = 'lib/data/categories/musica.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      category: 'Música',
      tema: 'Música',
      subtema: 'Artistas & Cantores Portugueses',
      subcategory: 'Artistas & Cantores Portugueses',
    })
...
prodLogs.push({
  batchId: 'BATCH_MUS_CANTORES_001',
