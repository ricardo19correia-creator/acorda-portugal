...
const batchFile = 'data/batches/batch_personalidades_cientistas_001.json'
const targetCategoryFile = 'lib/data/categories/personalidades.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      tema: 'Personalidades',
      subtema: 'Cientistas & Pensadores',
      subcategory: 'Cientistas & Pensadores',
    })
...
prodLogs.push({
  batchId: 'BATCH_PERS_CIENTISTAS_001',
