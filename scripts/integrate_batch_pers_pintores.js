...
const batchFile = 'data/batches/batch_personalidades_artistas_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      tema: 'Personalidades',
      subtema: 'Artistas & Pintores',
      subcategory: 'Artistas & Pintores',
    })
...
prodLogs.push({
  batchId: 'BATCH_PERS_PINTORES_001',
