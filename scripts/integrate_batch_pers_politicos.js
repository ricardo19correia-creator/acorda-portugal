...
const batchFile = 'data/batches/batch_personalidades_politicos_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      tema: 'Personalidades',
      subtema: 'Políticos & Estadistas',
      subcategory: 'Políticos & Estadistas',
    })
...
prodLogs.push({
  batchId: 'BATCH_PERS_POLITICOS_001',
