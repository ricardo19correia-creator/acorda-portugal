...
const batchFile = 'data/batches/batch_portugal_politico_ar_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      subtema: 'Assembleia da República',
      subcategory: 'Assembleia da República',
    })
