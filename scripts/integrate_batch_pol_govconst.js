...
const batchFile = 'data/batches/batch_portugal_politico_govconst_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      subtema: 'Governos Constitucionais',
      subcategory: 'Governos Constitucionais',
    })
...
prodLogs.push({
  batchId: 'BATCH_POL_GOVCONST_001',
