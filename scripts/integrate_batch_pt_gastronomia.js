...
const batchFile = 'data/batches/batch_portugal_gastronomia_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      category: 'Portugal',
      tema: 'Portugal',
      subtema: 'Gastronomia Portuguesa',
      subcategory: 'Gastronomia Portuguesa',
    })
...
prodLogs.push({
  batchId: 'BATCH_PT_GASTRONOMIA_001',
