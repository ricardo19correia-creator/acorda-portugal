...
const batchFile = 'data/batches/batch_portugal_vilas_aldeias_001.json'
const targetCategoryFile = 'lib/data/categories/portugal.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      category: 'Portugal',
      tema: 'Portugal',
      subtema: 'Vilas e Aldeias',
      subcategory: 'Vilas e Aldeias',
    })
...
prodLogs.push({
  batchId: 'BATCH_PT_VILAS_001',
  timestamp: new Date().toISOString(),
  category: 'portugal',
  theme: 'Portugal',
  subtheme: 'Vilas e Aldeias',
  count: addedCount,
  qualityGate: 'PASSED',
  sourceVerified: true,
})
