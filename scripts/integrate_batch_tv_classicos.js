...
const batchFile = 'data/batches/batch_tv_classicos_001.json'
const targetCategoryFile = 'lib/data/categories/cinema-tv.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      tema: 'Cinema e Televisão',
      subtema: 'Programas de Televisão Clássicos',
      subcategory: 'Programas de Televisão Clássicos',
    })
...
prodLogs.push({
  batchId: 'BATCH_TV_CLASSICOS_001',
  timestamp: new Date().toISOString(),
  category: 'cinema-tv',
  theme: 'Cinema e Televisão',
  subtema: 'Programas de Televisão Clássicos',
  count: addedCount,
  qualityGate: 'PASSED',
  sourceVerified: true,
