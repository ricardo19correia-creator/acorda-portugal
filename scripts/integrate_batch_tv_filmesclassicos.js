...
const batchFile = 'data/batches/batch_cinema_filmesclassicos_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      subtema: 'Filmes Clássicos',
      subcategory: 'Filmes Clássicos',
    })
...
prodLogs.push({
  batchId: 'BATCH_TV_FILMESCLASSICOS_001',
