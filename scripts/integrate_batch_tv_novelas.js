...
const batchFile = 'data/batches/batch_cinema_tv_novelas_001.json'
...
batch.forEach((q) => {
  if (!existingIds.has(q.id)) {
    currentCategoryQuestions.push({
      ...
      subtema: 'Telenovelas Portuguesas',
      subcategory: 'Telenovelas Portuguesas',
    })
